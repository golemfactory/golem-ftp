...
docker exec integration-yagna1-1 tc qdisc change dev eth0 root netem loss 0% 25% delay 120ms 10ms distribution normal
docker exec integration-yagna1-2 tc qdisc change dev eth0 root netem loss 0% 25% delay 120ms 10ms distribution normal
sleep 30
