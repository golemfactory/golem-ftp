...
docker exec integration-relay-1 tc qdisc add dev eth0 root tbf rate 4.0mbit burst 15k latency 25ms
docker exec integration-yagna1-1 tc qdisc add dev eth0 root tbf rate 4.0mbit burst 15k latency 25ms
docker exec integration-yagna2-1 tc qdisc add dev eth0 root tbf rate 4.0mbit burst 15k latency 25ms
sleep 30
