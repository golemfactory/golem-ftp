...
docker exec integration-central-1 tc qdisc change dev eth0 root netem loss 0% 25% delay 20ms 1ms distribution normal
#docker exec integration-yagna1-1 tc qdisc change dev eth0 root netem loss 0% 25% delay 20ms 2ms distribution normal
#docker exec integration-yagna2-1 tc qdisc change dev eth0 root netem loss 0% 25% delay 20ms 2ms distribution normal
sleep 30
